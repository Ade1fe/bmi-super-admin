...
export default function InvoicePage() {
  return (
    <AppShell title="Subscription" activeSection="schools">
      <div className="mx-auto max-w-[760px]">
        <section className="text-center">
          <h1 className="text-[28px] font-extrabold tracking-[-0.04em] text-[#17345d]">
            Invoice #INV-2023-001
          </h1>
          <div className="mt-4 flex items-center justify-center gap-3 text-[18px] text-[#304a72]">
        ...
        <section className="mt-10 rounded-[24px] bg-white shadow-[0_18px_42px_rgba(182,192,227,0.12)]">
          <div className="rounded-t-[24px] bg-[#f4f6ff] px-8 py-6 text-[16px] font-extrabold uppercase tracking-[0.08em] text-[#4758d5]">
            Invoice Details
          </div>
