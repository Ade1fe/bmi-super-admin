...
//     {
//       label: "LATEST SCHOOL",
//       value: newestSchool?.name ?? "No schools yet",
//       note: newestSchool ? formatJoinedDate(newestSchool.createdAt) : "Waiting for backend data",
//       noteClassName: "text-[#456ef7]",
//     },
//     {
//       label: "SCHOOL ADMINS",
//       value: formatCompactNumber(totalSchoolAdmins),
//       note: "Counted from school user relationships",
//       noteClassName: "text-[#28c85d]",
//     },
//     {
//       label: "CONNECTED EMAIL",
//       value: session?.user?.email ?? "No session",
//       note: session?.role ?? "guest",
//       noteClassName: "text-[#456ef7]",
//     },
//     {
//       label: "API STATUS",
//       value: errorMessage ? "Issue" : session?.token ? "Connected" : "Pending",
//       note: errorMessage || "Bearer token active for admin endpoints",
//       noteClassName: errorMessage ? "text-[#ff4747]" : "text-[#28c85d]",
//     },
//   ];
...
//               <p className="text-[24px] font-extrabold tracking-[-0.04em] text-[#17345d]">
//                 {item.value}
//               </p>
//               {index === 3 && !errorMessage ? (
//                 <span className="text-[#0f8d4e]">
//                   <ArrowUpRight className="h-7 w-7" strokeWidth={2.2} />
//                 </span>
//               ) : null}
//             </div>
//             <p className={`mt-3 text-[14px] font-bold ${item.noteClassName}`}>{item.note}</p>
//           </article>
//         ))}
//       </section>
//     </AppShell>
