      ...
      <div className="mx-auto max-w-[936px]">
        ...
        <section className="mt-10 rounded-[14px] bg-white p-8 shadow-[0_18px_42px_rgba(182,192,227,0.12)] sm:p-10">
          <div className="flex flex-col gap-8 md:flex-row md:items-center">
            <div className="flex h-[132px] w-[132px] shrink-0 items-center justify-center rounded-full bg-[#5c7837] text-center text-white shadow-[inset_0_0_0_4px_rgba(255,255,255,0.08)] sm:h-[168px] sm:w-[168px]">
              <div>
            ...
            <div>
              ...
              <div className="mt-5 flex flex-wrap gap-4">
                <button
                  type="button"
                  className="inline-flex h-14 items-center rounded-[10px] bg-[#edf5f1] px-6 text-[15px] font-semibold text-[#0f8751]"
                >
                  Upload New
                </button>
                <button
                  type="button"
                  className="inline-flex h-14 items-center rounded-[10px] bg-[#f2f3f5] px-8 text-[15px] font-semibold text-[#66686f]"
                >
                  Remove
                </button>
              </div>
        ...
        <section className="mt-8 rounded-[14px] bg-white p-8 shadow-[0_18px_42px_rgba(182,192,227,0.12)] sm:p-10">
          <h2 className="text-[22px] font-extrabold tracking-[-0.04em] text-[#17345d]">
            School Details
          </h2>
          ...
          <div className="mt-10 grid gap-x-5 gap-y-7 md:grid-cols-2">
            ...
            <label className="col-span-full">
              ...
              <textarea
                ...
                className="min-h-[176px] w-full rounded-[10px] border border-[#d9e0ef] bg-white px-5 py-5 text-[15px] text-[#264267] outline-none"
              />
            </label>
          </div>
        </section>
